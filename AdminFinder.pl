...
system("color c");
system('cls');
system('title Admin Control Panel Finder By Absolut Team');
...
print"
                                       ...
                                       |         - Absolut AdminFinder -          |
                                       |            - Absolut Team -              |
                                       |        - Kod BayLeux'a Aittir  -         |
                                       |   - Discord: discord.gg/gvaE8fAaTT  -    |
                                       --------------------------------------------
";
...
print " Arastirilacak Siteyi Yazin. \n";
print" Ornek: www.domaine.com or www.domain.com/path\n";
print" > ";
$site=<STDIN>;
chomp $site;

print "\n\n";
print " Websitenin Seklini Seciniz. \n";
print" e.g.: asp, php, cfm, any\n";
print" Web sitenin hangi kodla yazildigini bilmiyorsaniz any yazmaniz yeterlidir.\n";
print" > ";
$code=<STDIN>;
chomp($code);
...
print "->Arastirilacak Site: $site\n";
print "->Web sitesinin kaynagi: $code\n";
print "->Yonetici kontrol panelinin taramasi devam ediyor...\n\n\n";
...
print " \n [+] Admin Paneli Bulundu. -> $final\n\n";
print " \n Basarili. Bir Admin Paneli Daha Bulundu.\n\n";
}else{
print "[-] Bulunamadi. <- $final\n";
}
}
}
